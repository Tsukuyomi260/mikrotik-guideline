        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className={`w-full max-w-md p-6 sm:p-8 rounded-3xl border shadow-2xl space-y-5 text-center ${
            ...
            <div className="space-y-2.5">
              ...
              <a
                href={PRODUCT_PAGE_DATA.guideUrl}
                className={`w-full py-3 px-4 rounded-xl text-xs sm:text-sm font-bold border transition flex items-center justify-center gap-2 ${
              ...
              >
                ...
                <span>Déjà payé ? Accéder au guide complet</span>
              </a>
            </div>
